...
{% include figure.liquid loading="eager" path="assets/img/projects/project-bls-overview.png" class="img-fluid rounded z-depth-1" %}

{% include figure.liquid loading="eager" path="assets/img/projects/project-bls-report-automation-adrecall.png" class="img-fluid rounded z-depth-1" %}

{% include figure.liquid loading="eager" path="assets/img/projects/project-bls-report-automation.png" class="img-fluid rounded z-depth-1" %}
