...
{% include figure.liquid loading="eager" path="/assets/img/posts/docker-container.png" class="img-fluid rounded z-depth-1" width="50%" %}
...
{% include figure.liquid loading="eager" path="/assets/img/posts/container-security-cover.png" class="img-fluid rounded z-depth-1" %}
