...
tags: writing, logging
categories: writing
disqus_comments: true
thumbnail: /assets/img/posts/geultto4.png
toc:
  sidebar: left
---

{% include figure.liquid loading="eager" path="/assets/img/posts/geultto4.png" class="img-fluid rounded z-depth-1" width="50%" %}
...
{% include figure.liquid loading="eager" path="/assets/img/posts/geultto-wanted.jpg" class="img-fluid rounded z-depth-1" width="50%" height="70%" %}
